...
const functions = {
  ...
  getAllTasks: async () => {
    const taskList = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/tasks/"
    );
    return taskList;
  },
  ...
  getOneTask: async id => {
    const task = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/tasks/" + id
    );
  ...
  getRequests: async () => {
    const response = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/requests/"
    );
    return response;
  },
  getRequestById: async id => {
    const response = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/requests/" + id
    );
    return response;
  },
  ...
  getadmins: async () => {
    const admins = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/admins"
    );
    return admins;
  },
  ...
  getadmin: async id => {
    const admin = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/admins/" + id
    );
    return admin;
  },
  ...
  deleteAdmin: async id => {
    const deletedAdmin = await axios.delete(
      "https://lirten-hub-ideots.herokuapp.com/api/admins/" + id
    );
    return deletedAdmin;
  },
  ...
  getAllReviews: async () => {
    const reviewList = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/reviews"
    );
    return reviewList;
  },
  ...
  deleteOnereview: async id => {
    const review = await axios.delete(
      "https://lirten-hub-ideots.herokuapp.com/api/reviews/" + id
    );
    return review;
  },
  ...
  getAllEventRequest: async () => {
    const eventRequestList = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/eventRequests"
    );
    return eventRequestList;
  },

  getOneEventRequest: async id => {
    const eventRequest = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/eventRequests/" + id
    );
    return eventRequest;
  },
  ...
  postEventRequest: async () => {
    params = {
      ...
      description:
        "hahffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffah",
      type: "hals",
  ...
  deleteOneEventRequest: async id => {
    const eventRequest = await axios.delete(
      "https://lirten-hub-ideots.herokuapp.com/api/eventRequests/" + id
    );
    return eventRequest;
  },

  searchTasksByPayment: async money => {
    const result = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/tasks/search/payment=" +
        money
    );
    return result;
  },
  ...
  postOneTask: async () => {
    params = {
      ...
      payment: 13245,
      finalProduct:
        "https://drive.google.com/drive/folders/0BzEl8pp_zP5efnlONkxEb1NIM25zZ0lsa0NKdTgwWEk2LW40MkpHNnBhaXJsTFJrem9GZ2c?dti=395296137294031&fref=gc",
      timeLine: "2019-05-05",
      state: "pending",
      category: "MET",
      yearsOfExperience: 12,
  ...
  getAllEvents: async () => {
    allEvents = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/events/"
    );
    return allEvents;
  },
  getAnEventByID: async id => {
    theEvent = await axios.get(
      `https://lirten-hub-ideots.herokuapp.com/api/events/` + id
    );
    return theEvent;
  },
  getAnEventUsingLocation: async (city, area, Street) => {
    theEvent = await axios.get(
      `https://lirten-hub-ideots.herokuapp.com/api/events/search/${city}/${area}/${Street}`
    );
    return theEvent;
  },
  getAnEventByType: async type => {
    theEvent = await axios.get(
      `https://lirten-hub-ideots.herokuapp.com/api/events/search/${type}`
    );
    return theEvent;
  },
  getRecommendedEvents: async id => {
    theEvent = await axios.get(
      `https://lirten-hub-ideots.herokuapp.com/api/events/recommended/${id}"`
    );
    return theEvent;
  },
  ...
  updatingAnEvent: async (id, params) => {
    const theEvent = await axios.put(
      `https://lirten-hub-ideots.herokuapp.com/api/events/${id}`,
      params
    );
    return theEvent;
  ...
  getAllUsers: async () => {
    ...
    const users = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/users/"
    );
    return users;
  },
  ...
  getSpecifiedUser: async () => {
    ...
    //  //console.log(userId)
    const specifiedUser = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/users/" + userId
    );
  ...
  getAllMembers: async () => {
    ...
    const members = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/users/members"
    );
    return members;
  },
  ...
  updateSpecificUser: async body => {
    ...
    const userId = users.data.data[users.data.data.length - 1]._id;
    //console.log(userId)
    const specifiedUser = await axios.put(
      "https://lirten-hub-ideots.herokuapp.com/api/users/" + userId,
      body
    );
    return specifiedUser;
  ...
  searchEventByLocation: async (city, Street, Area) => {
    const events = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/events/search/" +
        city +
        "/" +
        Street +
        "/" +
  ...
  getAllEventBooking: async () => {
    const eventBookingList = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/eventBookings/"
    );
    return eventBookingList;
  },

  getOneEventBooking: async id => {
    const eventBooking = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/eventBookings/" + id
    );
    return eventBooking;
  },
  ...
  deleteOneEventBooking: async id => {
    const eventBooking = await axios.delete(
      "https://lirten-hub-ideots.herokuapp.com/api/eventBookings/" + id
    );
    return eventBooking;
  },
  ...
  searchTasksByCategory: async cat => {
    const result = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/tasks/search/category=" + cat
    );
    return result;
  },
  ...
  searchTcasksByYearsOfExp: async exp => {
    const result = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/tasks/search/experience=" +
        exp
    );
    return result;
  },
  ...
  getAllNotifications: async () => {
    const notifications = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/notifications"
    );
  ...
  postApplication: async () => {
    ...
    const app = await axios.post(
      "https://lirten-hub-ideots.herokuapp.com/api/application",
      config
    );
    return app;
  },
  ...
  getApplication: async id => {
    const application = await axios.get(
      "https://lirten-hub-ideots.herokuapp.com/api/application/" + id
    );
    return application;
  },
  ...
  deleteApplication: async id => {
    const application = await axios.delete(
      "https://lirten-hub-ideots.herokuapp.com/api/application/" + id
    );
    return application;
  }
